...
function CHeroDemo:InitGameMode()
    ...
    CustomGameEventManager:RegisterListener( "KillNeutralsButtonPressed", function(...) return self:OnKillNeutralsButtonPressed( ... ) end )
    ...
    CustomGameEventManager:RegisterListener( "SpawnAllyUnitButtonPressed", function(...) return self:OnSpawnAllyUnitButtonPressed( ... ) end )
    ...
    CustomGameEventManager:RegisterListener( "SpawnEnemyUnitButtonPressed", function(...) return self:OnSpawnEnemyUnitButtonPressed( ... ) end )
    CustomGameEventManager:RegisterListener( "SpawnNeutralUnitButtonPressed", function(...) return self:OnSpawnNeutralUnitButtonPressed( ... ) end )
